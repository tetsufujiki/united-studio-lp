        ...
        >
          <div className="relative overflow-hidden rounded-3xl border border-primary/40 bg-gradient-to-br from-card/90 via-card/70 to-card/90 px-12 py-12 backdrop-blur-md md:px-16 md:py-14">
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              ...
              {/* Starting from - Muted */}
              <p className="mb-2 text-xs font-medium uppercase tracking-[0.15em] text-muted-foreground/50">
                Starting from
              </p>
              
              {/* Price - Most important numeric element */}
              <div className="flex items-baseline gap-2">
                <span className="text-lg font-medium text-foreground/80 md:text-xl">2時間</span>
                <span className="text-4xl font-bold tracking-tight text-primary md:text-5xl">¥14,000</span>
