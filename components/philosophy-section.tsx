      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 md:px-12">
        ...
        <div className="mb-24 md:mb-28">
          ...
          <p className="text-base tracking-wide text-[#9a9590] leading-relaxed">
            新河岸音楽工務所は、プロジェクトベースの制作スタジオです
          </p>
        </div>

        {/* Philosophy spec rows - increased spacing between items */}
        <div className="space-y-5">
          {philosophyItems.map((item) => (
            <div
              key={item.titleEn}
              className="group flex items-center gap-6 rounded-lg border border-[#2a2c32]/40 bg-[#15161a]/30 px-6 py-5 backdrop-blur-sm hover:border-[#3a3c42]/50 hover:bg-[#1a1c22]/40"
            >
              {/* Icon container - softer styling */}
              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-md border border-[#2a2c32]/50 bg-[#0f1014]/60 text-[#7a7570] group-hover:border-primary/25 group-hover:text-primary/60">
