...
export const faqSections: FAQSection[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: '伴奏音源（カラオケ）をご用意ください。歌詞カードは必要に応じてご準備ください。あとは喉を潤すお水などをご持参いただければ大丈夫です。',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer: '音源は、事前にお送りいただくことをおすすめしています。ご来店前に再生確認と録音準備を行えるため、当日の収録をスムーズに始められます。送付には[[LINE]]をご利用いただくのが簡単です。当日、USBメモリでお持ちいただいても構いません。',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        question: '録音しながら撮影できますか？',
        answer: '録音作業中はスタッフによるカメラ操作ができないため、撮影はお客様ご自身でお願いいたします。カメラマンに同行いただくことも可能です。',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      {
        question: '付き添いや見学はできますか？',
        answer: 'はい、可能です。付き添いや見学の方も一緒にお越しいただけます。',
      },
    ],
  },
];
